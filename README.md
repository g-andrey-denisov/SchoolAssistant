...
| ФИО ученика | День рождения | ФИО родителя | Телефон | Примечание | Пол |
|-------------|---------------|--------------|---------|------------|-----|
...
ФИО ученика | День рождения | ФИО родителя | Телефон | Примечание | Пол
```
(столбец «Пол» можно не создавать заранее — бот пишет значение в шестую колонку
при добавлении ученика; для наглядности рекомендуется добавить заголовок вручную)
